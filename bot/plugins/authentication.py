...
async def _auth(c, m):
    ...
    try:
        ...
        await msg2.reply_text("هذه بيانات التفويض الخاصة بك! احفظ هذا للاستخدام لاحقا. الرد بـ /save_auth_data إلى بيانات التفويض لإعادة تفويضها لاحقا. (helpful if you use Heroku)", True)
